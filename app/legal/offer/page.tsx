        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1 ml-4 mt-2">
              <li>FREE — бесплатный тариф (20 генераций без AI-изображений после регистрации)</li>
              <li>ADVANCED — платный тариф (100 генераций на 30 дней с AI-изображениями высокого качества)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1 ml-4 mb-2">
              <li>Тариф FREE: 0₽ (бесплатно, выдается после регистрации)</li>
              <li>Тариф ADVANCED: 10₽ за 30 календарных дней с момента оплаты</li>
            </ul>
            <p className="text-gray-300 mb-2">
              3.1.1. Ценообразование генераций для тарифа ADVANCED:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-1 ml-4 mb-2">
              <li>Генерация с 1-5 AI-изображениями = 1 генерация</li>
              <li>Генерация с 6-10 AI-изображениями = 2 генерации</li>
              <li>Инпейнтинг (редактирование изображений): каждые 5 операций = 1 генерация</li>
            </ul>
            <p className="text-gray-300 mb-2">
          ...
          <section>
            ...
            <p className="text-gray-300 mb-2">
              4.1. Тарифный план ADVANCED действует в течение 30 календарных дней с момента оплаты.
            </p>
            <p className="text-gray-300 mb-2">
              4.2. После окончания срока действия подписки ADVANCED (30 дней), доступ к расширенным
              функциям прекращается, и пользователь автоматически возвращается к тарифу FREE
              с 20 бесплатными генерациями без AI-изображений.
            </p>
            <p className="text-gray-300 mb-2">
              4.3. Неиспользованные генерации тарифа ADVANCED не переносятся на следующий период
              и не сохраняются после окончания срока подписки.
            </p>
            <p className="text-gray-300">
          ...
          <section>
            ...
            <p className="text-gray-300 mb-2">
              ...
              генераций (не более 10 генераций для тарифа ADVANCED из 100 доступных).
            </p>
            <p className="text-gray-300 mb-2">
