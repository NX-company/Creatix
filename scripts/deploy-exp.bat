@echo off
echo ========================================
echo   DEPLOY EXPERIMENTAL BRANCH
echo ========================================
echo.
echo This will:
echo 1. Switch to main branch
echo 2. Merge dev/experimental into main
...
echo.
echo [3/5] Merging dev/experimental into main...
git merge dev/experimental --no-ff -m "Merge dev/experimental into main"
if %ERRORLEVEL% NEQ 0 (
